...
NOMINATIONS = [
    {"id": "1", "title": "1. Общественное пространство", "finalists": ["Курган", "Парк Толстого", "Набережная"]},
    {"id": "2", "title": "2. Уютное место", "finalists": ["Щебетун ДК", "Дача", "Микале"]},
    {"id": "3", "title": "3. Кофейня", "finalists": ["Микале", "Механика", "Твоя кофейня"]},
    {"id": "4", "title": "4. Гастропроект", "finalists": ["Фиби", "Итальянцы", "Терки"]},
    {"id": "5", "title": "5. Ночная локация", "finalists": ["Цензура", "Тако Бойс", "Роллингс"]},
    {"id": "6", "title": "6. Открытие", "finalists": ["Аэротермы", "Терки", "Чебурекми"]},
    {"id": "7", "title": "7. Событие", "finalists": ["Премия БРЯ", "Рок-выпускной", "Фест кофе"]},
    {"id": "8", "title": "8. Личность", "finalists": ["Р.Формин", "М.Охременко", "С.Лапенков"]},
    {"id": "9", "title": "9. Сообщество", "finalists": ["Пространство", "БРЯ", "Новые люди"]},
    {"id": "10", "title": "10. Инициатива", "finalists": ["Путеводитель", "Субботники", "Памятник"]},
]
